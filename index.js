(function() {
  ...
  var _sfc_render = function render() {
    ...
    return _c("k-panel-inside", { staticClass: "k-meta-kit-view" }, [_vm.legacyDetection.show && _vm.legacyDetection.found > 0 ? _c("div", { staticClass: "k-meta-kit-warning" }, [_c("k-box", { attrs: { "theme": "info" } }, [_c("k-icon", { attrs: { "type": "info" } }), _c("span", [_vm._v("Found " + _vm._s(_vm.legacyDetection.found) + " pages with legacy SEO metadata")]), _c("k-button", { attrs: { "icon": "download" }, on: { "click": _vm.showLegacyDialog } }, [_vm._v("View & Convert")]), _c("k-button", { attrs: { "icon": "cancel" }, on: { "click": _vm.dismissLegacyWarning } }, [_vm._v("Dismiss")])], 1)], 1) : _vm._e(), _c("div", { staticClass: "k-meta-kit-stats" }, [_c("div", { staticClass: "k-meta-kit-stats-card" }, [_c("h3", [_vm._v("Total Pages")]), _c("p", [_vm._v(_vm._s(_vm.pages.length))])]), _c("div", { staticClass: "k-meta-kit-stats-card" }, [_c("h3", [_vm._v("With Description")]), _c("p", [_vm._v(_vm._s(_vm.pagesWithDescription))])]), _c("div", { staticClass: "k-meta-kit-stats-card" }, [_c("h3", [_vm._v("With OG Image")]), _c("p", [_vm._v(_vm._s(_vm.pagesWithOgImage))])]), _c("div", { staticClass: "k-meta-kit-stats-card" }, [_c("h3", [_vm._v("NoIndex")]), _c("p", [_vm._v(_vm._s(_vm.pagesNoIndex))])])]), _c("div", { staticClass: "k-meta-kit-actions" }, [_c("k-button-group", [_c("k-button", { attrs: { "icon": "sparkling", "disabled": _vm.isGeneratingAll, "progress": _vm.isGeneratingAll }, on: { "click": _vm.generateAllDescriptions } }, [_vm._v(" Generate All Missing Descriptions ")]), _c("k-button", { attrs: { "icon": "refresh" }, on: { "click": _vm.refreshPages } }, [_vm._v("Refresh")]), _c("k-button", { attrs: { "icon": "edit" }, on: { "click": _vm.showAllPagesDialog } }, [_vm._v("Edit All Pages")]), _c("k-button", { attrs: { "icon": "download" }, on: { "click": _vm.detectLegacyMetadata } }, [_vm._v("Detect Legacy Data")])], 1)], 1), _c("div", { staticClass: "k-meta-kit-table" }, [_c("table", [_c("thead", [_c("tr", [_c("th", [_vm._v("#")]), _c("th", [_vm._v("Page")]), _c("th", [_vm._v("Template")]), _c("th", [_vm._v("Meta Title")]), _c("th", [_vm._v("Description")]), _c("th", [_vm._v("OG Image")]), _c("th", [_vm._v("NoIndex")]), _c("th", [_vm._v("Actions")])])]), _c("tbody", _vm._l(_vm.pagesData, function(page, index) {
      ...
      } } }), _c("k-button", { attrs: { "icon": "magic", "size": "sm", "disabled": page.hasMetaDescription, "title": "Generate Description" }, on: { "click": function($event) {
    ...
    } } }, [_vm._v(" Current ")]), _c("k-button", { attrs: { "size": "xs", "theme": _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "manual" ? "positive" : "" }, on: { "click": function($event) {
      return _vm.setFieldChoice(_vm.currentEditPage.id, "metaTitle", "manual");
    } } }, [_vm._v(" Manual Edit ")]), _c("k-button", { attrs: { "size": "xs", "icon": "sparkling", "theme": _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "ai" ? "positive" : "", "disabled": _vm.isGeneratingField(_vm.currentEditPage.id, "metaTitle") }, on: { "click": function($event) {
      return _vm.generateFieldAI(_vm.currentEditPage.id, "metaTitle");
    } } }, [_vm._v(" AI Generate ")])], 1), _c("div", { staticClass: "k-meta-kit-legacy-field-preview" }, [_vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "legacy" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Legacy Value")]), _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(_vm._s(_vm.currentEditPage.legacy.metaTitle))])]) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "keep" || !_vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Current Value")]), _vm.currentEditPage.hasMetaTitle ? _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(" " + _vm._s(_vm.currentEditPage.metaTitle || "—") + " "), _c("span", { staticClass: "k-meta-kit-field-length", class: _vm.getStatusClass(_vm.currentEditPage.hasMetaTitle, _vm.currentEditPage.metaTitleLength) }, [_vm._v(" (" + _vm._s(_vm.currentEditPage.metaTitleLength) + " chars) ")])]) : _c("span", { staticClass: "k-meta-kit-legacy-field-value-empty" }, [_vm._v("No meta title set")])]) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "manual" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Manual Entry")]), _c("k-input", { attrs: { "value": _vm.getManualValue(_vm.currentEditPage.id, "metaTitle"), "placeholder": "Enter Meta Title", "type": "text" }, on: { "input": function($event) {
      return _vm.setManualValue(_vm.currentEditPage.id, "metaTitle", $event);
    } } })], 1) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") === "ai" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge k-meta-kit-legacy-badge-ai" }, [_vm._v("AI Generated")]), _vm.isGeneratingField(_vm.currentEditPage.id, "metaTitle") ? _c("span", { staticClass: "k-meta-kit-legacy-field-generating" }, [_c("k-icon", { staticClass: "k-meta-kit-spinner", attrs: { "type": "loader" } }), _vm._v(" Generating... ")], 1) : _vm.getManualValue(_vm.currentEditPage.id, "metaTitle") ? _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(" " + _vm._s(_vm.getManualValue(_vm.currentEditPage.id, "metaTitle")) + " ")]) : _c("span", { staticClass: "k-meta-kit-legacy-field-value-empty" }, [_vm._v(" Click AI Generate to create content ")])]) : _vm._e()]), _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") && _vm.getFieldChoice(_vm.currentEditPage.id, "metaTitle") !== "keep" ? _c("k-button", { attrs: { "icon": "check", "size": "sm", "theme": "positive" }, on: { "click": function($event) {
    ...
    } } }, [_vm._v(" Current ")]), _c("k-button", { attrs: { "size": "xs", "theme": _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "manual" ? "positive" : "" }, on: { "click": function($event) {
      return _vm.setFieldChoice(_vm.currentEditPage.id, "metaDescription", "manual");
    } } }, [_vm._v(" Manual Edit ")]), _c("k-button", { attrs: { "size": "xs", "icon": "sparkling", "theme": _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "ai" ? "positive" : "", "disabled": _vm.isGeneratingField(_vm.currentEditPage.id, "metaDescription") }, on: { "click": function($event) {
      return _vm.generateFieldAI(_vm.currentEditPage.id, "metaDescription");
    } } }, [_vm._v(" AI Generate ")])], 1), _c("div", { staticClass: "k-meta-kit-legacy-field-preview" }, [_vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "legacy" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Legacy Value")]), _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(_vm._s(_vm.currentEditPage.legacy.metaDescription))])]) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "keep" || !_vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Current Value")]), _vm.currentEditPage.hasMetaDescription ? _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(" " + _vm._s(_vm.currentEditPage.metaDescription || "—") + " "), _c("span", { staticClass: "k-meta-kit-field-length", class: _vm.getStatusClass(_vm.currentEditPage.hasMetaDescription, _vm.currentEditPage.metaDescriptionLength) }, [_vm._v(" (" + _vm._s(_vm.currentEditPage.metaDescriptionLength) + " chars) ")])]) : _c("span", { staticClass: "k-meta-kit-legacy-field-value-empty" }, [_vm._v("No meta description set")])]) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "manual" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge" }, [_vm._v("Manual Entry")]), _c("k-input", { attrs: { "value": _vm.getManualValue(_vm.currentEditPage.id, "metaDescription"), "placeholder": "Enter Meta Description", "type": "textarea", "buttons": "false" }, on: { "input": function($event) {
      return _vm.setManualValue(_vm.currentEditPage.id, "metaDescription", $event);
    } } })], 1) : _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") === "ai" ? _c("div", { staticClass: "k-meta-kit-legacy-field-option" }, [_c("span", { staticClass: "k-meta-kit-legacy-badge k-meta-kit-legacy-badge-ai" }, [_vm._v("AI Generated")]), _vm.isGeneratingField(_vm.currentEditPage.id, "metaDescription") ? _c("span", { staticClass: "k-meta-kit-legacy-field-generating" }, [_c("k-icon", { staticClass: "k-meta-kit-spinner", attrs: { "type": "loader" } }), _vm._v(" Generating... ")], 1) : _vm.getManualValue(_vm.currentEditPage.id, "metaDescription") ? _c("span", { staticClass: "k-meta-kit-legacy-field-value" }, [_vm._v(" " + _vm._s(_vm.getManualValue(_vm.currentEditPage.id, "metaDescription")) + " ")]) : _c("span", { staticClass: "k-meta-kit-legacy-field-value-empty" }, [_vm._v(" Click AI Generate to create content ")])]) : _vm._e()]), _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") && _vm.getFieldChoice(_vm.currentEditPage.id, "metaDescription") !== "keep" ? _c("k-button", { attrs: { "icon": "check", "size": "sm", "theme": "positive" }, on: { "click": function($event) {
      return _vm.applySingleFieldAndClose(_vm.currentEditPage.id, "metaDescription");
    } } }, [_vm._v(" Apply Meta Description ")]) : _vm._e()], 1)])]) : _vm._e()], 1)], 1);
  };
