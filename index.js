(function() {
  ...
  const _sfc_main$2 = {
    ...
    computed: {
      ...
      showPreview() {
        return !this.isSitePage && this.value && this.siteSettings.appendSiteName && this.siteSettings.siteMetaTitle;
      },
      fullTitle() {
