(function() {
  ...
  var _sfc_render = function render() {
    ...
    return _c("k-panel-inside", { staticClass: "k-meta-kit-view" }, [_vm.languages && _vm.languages.length > 1 ? _c("div", { staticClass: "k-meta-kit-language-bar" }, [_c("k-button-group", _vm._l(_vm.languages, function(lang) {
      ...
      } } }), _c("div", { staticClass: "k-meta-kit-dialog-field-meta" }, [_c("span", [_vm.getEditableValue(page.id, "metaTitle", page.metaTitle) ? _c("span", { staticClass: "k-meta-kit-field-length", class: _vm.getStatusClass(true, _vm.getEditableValue(page.id, "metaTitle", page.metaTitle).length, "title") }, [_vm._v(" " + _vm._s(_vm.getEditableValue(page.id, "metaTitle", page.metaTitle).length) + " chars ")]) : _vm._e()]), _vm.aiEnabled ? _c("k-button", { attrs: { "icon": "sparkling", "size": "xs", "disabled": _vm.isGeneratingField(page.id, "metaTitle"), "title": "AI Generate" }, on: { "click": function($event) {
